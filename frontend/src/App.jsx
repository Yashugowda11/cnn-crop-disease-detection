        ...
        <div className="workspace">
          ...
          <section className="panel results-panel">
            ...
            {!loading && result && !result.error && <div className="report">
              ...
              <div className="guidance-grid"><article className="guidance-card"><span className="guidance-icon green">✓</span><div><span className="label">WHAT TO DO</span><p>{guidance?.solution || result.recommendation}</p></div></article><article className="guidance-card"><span className="guidance-icon amber">⌁</span><div><span className="label">PESTICIDE OPTIONS</span><p>{guidance?.pesticide || "Consult a local agricultural expert for an approved treatment."}</p></div></article></div>
